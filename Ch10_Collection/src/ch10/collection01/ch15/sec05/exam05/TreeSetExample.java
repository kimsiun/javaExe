package ch10.collection01.ch15.sec05.exam05;
 ...
 * 내가 원하는 값을 찾을 대까지 계속 노드의 값을 비교하면 왼쪽 or 오른쪽을 따라간다.
 * 
 * '데이터 입력 시 정렬과정을 거치게 되므로 list 보다 입력 속도가 느리다'
 * '특정 값 검색시 Hash 보다는 느리지만 list 보다는 훨씬 빠르다.'
 * '노드의 좌측/우측 명백하게 작으냐 크냐로 구분되므로 비교검색시 가장 좋은 구조'
 * '정렬이 일어나므로 순서보장 안된다'
 * 
 * 값자체를 비교하면 TreeSet
