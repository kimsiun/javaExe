 ...
 *		라이브러리로 제고되는 방식이 아니라서 개발자가 모두 직접 정의해야 함.
...
Java 는 JDK라는 라이브러리를 제공하므로 직접 여러 모듈/클래스/메서드 설계했다.
설계 과정에서 일어날 수 있는 모든 Error 에 대해서 '미리 정의된 Exception'을
